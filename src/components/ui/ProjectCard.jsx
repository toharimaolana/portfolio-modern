...
const ProjectCard = ({ project }) => {
  return (
    ...
    >
      ...
      {/* --- 2. Gradient Overlay (Untuk Keterbacaan Teks) --- */}
      ...
      {/* Optional: Accent Glow Overlay on Hover */}
      ...
      <div className="absolute inset-0 flex flex-col justify-end p-6 sm:p-8 z-10">
        ...
        {/* Description (Hidden by default, visible on hover/large screens if preferred) */}
